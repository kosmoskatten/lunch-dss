...
Elm.Position.make = function (_elm) {
   ...
   var _op = {};
   var unit = 75000;
   var toMeter = function (_p0) {    var _p1 = _p0;return _p1._0 * unit;};
   var toKM = function (d) {    var d$ = toMeter(d);return d$ / 1000;};
   var renderDistance = function (d) {
      var asMeter = toMeter(d);
      return _U.cmp(asMeter,10000) < 0 ? A2($Basics._op["++"],$Basics.toString($Basics.round(asMeter))," m") : A2($Basics._op["++"],
   ...
   var Position = F2(function (a,b) {    return {latitude: a,longitude: b};});
   var position = A3($Json$Decode.object2,
   Position,
   A2($Json$Decode._op[":="],"latitude",$Json$Decode.$float),
...
Elm.Restaurant.make = function (_elm) {
   "use strict";
   _elm.Restaurant = _elm.Restaurant || {};
   if (_elm.Restaurant.values) return _elm.Restaurant.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Restaurant = F4(function (a,b,c,d) {    return {name: a,url: b,rating: c,position: d};});
   var restaurant = A5($Json$Decode.object4,
   Restaurant,
   A2($Json$Decode._op[":="],"name",$Json$Decode.string),
   A2($Json$Decode._op[":="],"url",$Json$Decode.string),
   A2($Json$Decode._op[":="],"rating",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"position",$Position.position));
   return _elm.Restaurant.values = {_op: _op,restaurant: restaurant,Restaurant: Restaurant};
};
...
Elm.Storage.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var storageMailbox = $Signal.mailbox({op: "NoOp",values: _U.list([])});
   var fetchFor = function (names) {    return A2($Signal.send,storageMailbox.address,{op: "fetchAll",values: names});};
   var dec = function (name) {    return A2($Signal.send,storageMailbox.address,{op: "dec",values: _U.list([name])});};
   var inc = function (name) {    return A2($Signal.send,storageMailbox.address,{op: "inc",values: _U.list([name])});};
   var StorageData = F2(function (a,b) {    return {name: a,rating: b};});
   var StorageCtrl = F2(function (a,b) {    return {op: a,values: b};});
...
Elm.App.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var adjustRating = F3(function (name,g,rest) {    return _U.eq(name,rest.name) ? _U.update(rest,{rating: A2(g,rest.rating,1)}) : rest;});
   var thumbsDown = function (name) {    return A2(adjustRating,name,F2(function (x,y) {    return x - y;}));};
   var thumbsUp = function (name) {    return A2(adjustRating,name,F2(function (x,y) {    return x + y;}));};
   var restaurantsUrl = "/resources/restaurants.json";
   var decodeRestaurants = $Json$Decode.list($Restaurant.restaurant);
   ...
   var displayItemsByRating = F2(function (di1,di2) {    return A2($Basics.compare,di2.rating,di1.rating);});
   var makeDisplayItem = F2(function (model,rest) {
      return {name: rest.name
             ...
             ,distance: function () {
                ...
                if (_p3.ctor === "Just") {
                      return $Maybe.Just(A2($Position.calculateDistance,_p3._0,rest.position));
                   } else {
                      return $Maybe.Nothing;
                   }
             }()};
   });
   var viewRandomDisplay = F2(function (address,model) {    return $Html.text("Random");});
   var viewPageHeader = A2($Html.header,
   _U.list([$Html$Attributes.$class("w3-container w3-black")]),
   _U.list([A2($Html.h2,_U.list([$Html$Attributes.$class("w3-center")]),_U.list([$Html.text("Välj en matstrategi:")]))]));
   var DisplayItem = F4(function (a,b,c,d) {    return {name: a,url: b,rating: c,distance: d};});
   var Random = {ctor: "Random"};
   var Best = {ctor: "Best"};
   var Closest = {ctor: "Closest"};
   var NoOp = {ctor: "NoOp"};
   var fetchRatingsFor = function (names) {    return $Effects.task(A2($Task.andThen,$Storage.fetchFor(names),$Basics.always($Task.succeed(NoOp))));};
   var incStoredRatingFor = function (name) {    return $Effects.task(A2($Task.andThen,$Storage.inc(name),$Basics.always($Task.succeed(NoOp))));};
   var decStoredRatingFor = function (name) {    return $Effects.task(A2($Task.andThen,$Storage.dec(name),$Basics.always($Task.succeed(NoOp))));};
   var update = F2(function (action,model) {
      var _p4 = action;
      switch (_p4.ctor)
      {case "GpsPosition": return {ctor: "_Tuple2",_0: _U.update(model,{currentPosition: $Maybe.Just(_p4._0)}),_1: $Effects.none};
         case "GpsError": return {ctor: "_Tuple2",_0: _U.update(model,{gpsError: $Maybe.Just(_p4._0)}),_1: $Effects.none};
         case "GotRestaurants": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{restaurants: A2($Maybe.withDefault,_U.list([]),_p4._0)})
                                       ,_1: fetchRatingsFor(_U.list([]))};
         case "SwitchDisplay": return {ctor: "_Tuple2",_0: _U.update(model,{display: _p4._0}),_1: $Effects.none};
         case "ThumbsUp": var _p5 = _p4._0;
           return {ctor: "_Tuple2",_0: _U.update(model,{restaurants: A2($List.map,thumbsUp(_p5),model.restaurants)}),_1: incStoredRatingFor(_p5)};
         case "ThumbsDown": var _p6 = _p4._0;
           return {ctor: "_Tuple2",_0: _U.update(model,{restaurants: A2($List.map,thumbsDown(_p6),model.restaurants)}),_1: decStoredRatingFor(_p6)};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var ThumbsDown = function (a) {    return {ctor: "ThumbsDown",_0: a};};
   var ThumbsUp = function (a) {    return {ctor: "ThumbsUp",_0: a};};
   var viewDisplayItem = F2(function (address,item) {
      return A2($Html.tr,
      _U.list([$Html$Attributes.$class("w3-dark-grey")]),
      _U.list([A2($Html.td,
              _U.list([]),
              _U.list([A2($Html.a,_U.list([$Html$Attributes.href(item.url),$Html$Attributes.target("_blank")]),_U.list([$Html.text(item.name)]))]))
              ,A2($Html.td,_U.list([]),_U.list([$Html.text(A2($Maybe.withDefault,"-",A2($Maybe.map,$Position.renderDistance,item.distance)))]))
              ,A2($Html.td,_U.list([]),_U.list([$Html.text($Basics.toString(item.rating))]))
              ,A2($Html.td,
              _U.list([]),
              _U.list([A2($Html.i,
                      _U.list([$Html$Attributes.$class("fa fa-thumbs-o-up")
                              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding-right",_1: "15px"},{ctor: "_Tuple2",_0: "cursor",_1: "pointer"}]))
                              ,A2($Html$Events.onClick,address,ThumbsUp(item.name))]),
                      _U.list([]))
                      ,A2($Html.i,
                      _U.list([$Html$Attributes.$class("fa fa-thumbs-o-down")
                              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "cursor",_1: "pointer"}]))
                              ,A2($Html$Events.onClick,address,ThumbsDown(item.name))]),
                      _U.list([]))]))]));
   });
   ...
   var viewClosestDisplay = F2(function (address,model) {
      var items = A2($List.map,makeDisplayItem(model),model.restaurants);
      var sortedItems = A2($List.sortWith,displayItemsByDistance,items);
   ...
   var SwitchDisplay = function (a) {    return {ctor: "SwitchDisplay",_0: a};};
   var viewButtonGroup = function (address) {
      ...
      _U.list([A2($Html.button,
              _U.list([$Html$Attributes.$class("w3-btn w3-light-grey w3-border")
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "33.3%"}]))
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([viewPageHeader
              ...
              ,function () {
                 var _p7 = model.display;
                 switch (_p7.ctor)
                 {case "Closest": return A2(viewClosestDisplay,address,model);
                    case "Best": return A2(viewBestDisplay,address,model);
                    default: return A2(viewRandomDisplay,address,model);}
              }()]));
   });
   var GotRestaurants = function (a) {    return {ctor: "GotRestaurants",_0: a};};
   var getRestaurants = $Effects.task(A2($Task.map,GotRestaurants,$Task.toMaybe(A2($Http.get,decodeRestaurants,restaurantsUrl))));
   var initialModel = {ctor: "_Tuple2"
                      ,_0: {currentPosition: $Maybe.Nothing,gpsError: $Maybe.Nothing,restaurants: _U.list([]),display: Closest}
                      ,_1: getRestaurants};
   var GpsError = function (a) {    return {ctor: "GpsError",_0: a};};
   var GpsPosition = function (a) {    return {ctor: "GpsPosition",_0: a};};
   var Model = F4(function (a,b,c,d) {    return {currentPosition: a,gpsError: b,restaurants: c,display: d};});
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var storageCtrl = Elm.Native.Port.make(_elm).outboundSignal("storageCtrl",
   function (v) {
      return {op: v.op,values: Elm.Native.List.make(_elm).toArray(v.values).map(function (v) {    return v;})};
   },
   $Storage.storageMailbox.signal);
   var gpsError = Elm.Native.Port.make(_elm).inboundSignal("gpsError",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var gpsPosition = Elm.Native.Port.make(_elm).inboundSignal("gpsPosition",
   "Position.Position",
   function (v) {
      return typeof v === "object" && "latitude" in v && "longitude" in v ? {_: {}
                                                                            ,latitude: typeof v.latitude === "number" ? v.latitude : _U.badPort("a number",
                                                                            v.latitude)
                                                                            ,longitude: typeof v.longitude === "number" ? v.longitude : _U.badPort("a number",
                                                                            v.longitude)} : _U.badPort("an object with fields `latitude`, `longitude`",v);
   });
   var app = $StartApp.start({init: $App.initialModel
                             ,update: $App.update
                             ,view: $App.view
                             ,inputs: _U.list([A2($Signal.map,$App.GpsPosition,gpsPosition),A2($Signal.map,$App.GpsError,gpsError)])});
