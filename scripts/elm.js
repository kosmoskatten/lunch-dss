...
Elm.Position.make = function (_elm) {
       ...
       return _elm.Position.values = {_op: _op,Position: Position};
    };
Elm.App = Elm.App || {};
Elm.App.make = function (_elm) {
       ...
       var view = F2(function (address,model) {
                     return A2($Html.div,_U.list([]),_U.list([$Html.text("Hej")]));
                  });
       var update = F2(function (action,model) {
                       return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                    });
       var initialModel = {ctor: "_Tuple2"
                          ,_0: {currentPosition: $Maybe.Nothing,gpsError: $Maybe.Nothing}
                          ,_1: $Effects.none};
       ...
       var Model = F2(function (a,b) {
                      return {currentPosition: a,gpsError: b};
                   });
