...
Elm.Http.make = function (_elm) {
       ...
       var handleResponse = F2(function (handle,response) {
                               if (_U.cmp(200,response.status) < 1 && _U.cmp(response.status
                                                                            ,300) < 0) {
...
Elm.Restaurant.make = function (_elm) {
       ...
       $Signal = Elm.Signal.make(_elm);
       var _op = {};
       var Restaurant = F4(function (a,b,c,d) {
                           return {name: a,url: b,rating: c,position: d};
                        });
       ...
       return _elm.Restaurant.values = {_op: _op
...
Elm.Storage.make = function (_elm) {
       ...
       var storageMailbox = $Signal.mailbox({op: "NoOp"
                                            ,restaurant: $Maybe.Nothing
                                            ,restaurants: $Maybe.Nothing});
       var fetchFor = function (restaurants) {
          return A2($Signal.send
                   ,storageMailbox.address
                   ,{op: "fetchAll"
                    ,restaurant: $Maybe.Nothing
                    ,restaurants: $Maybe.Just(restaurants)});
       };
       var dec = function (name) {
          return A2($Signal.send
                   ,storageMailbox.address
                   ,{op: "dec"
                    ,restaurant: $Maybe.Just(name)
                    ,restaurants: $Maybe.Nothing});
       };
       ...
       var StorageCtrl = F3(function (a,b,c) {
                            return {op: a,restaurant: b,restaurants: c};
                         });
...
Elm.App.make = function (_elm) {
       ...
       var adjustRating = F3(function (name,g,rest) {
                             return _U.eq(name,rest.name) ? _U.update(rest
                                                                     ,{rating: A2(g,rest.rating,1)}) : rest;
                          });
       var thumbsDown = function (name) {
          return A2(adjustRating
                   ,name
                   ,F2(function (x,y) {
                      return x - y;
                   }));
       };
       var thumbsUp = function (name) {
          return A2(adjustRating
                   ,name
                   ,F2(function (x,y) {
                      return x + y;
       ...
       var NoOp = {ctor: "NoOp"};
       var fetchRatingsFor = function (restaurants) {
          return $Effects.task(A2($Task.andThen
                                 ,$Storage.fetchFor(restaurants)
                                 ,$Basics.always($Task.succeed(NoOp))));
       };
       var incStoredRatingFor = function (name) {
          return $Effects.task(A2($Task.andThen
                                 ,$Storage.inc(name)
                                 ,$Basics.always($Task.succeed(NoOp))));
       };
       var decStoredRatingFor = function (name) {
          return $Effects.task(A2($Task.andThen
                                 ,$Storage.dec(name)
                                 ,$Basics.always($Task.succeed(NoOp))));
       };
                       ...
                       switch (_p4.ctor)
                       {
                         ...
                         case "GpsError":
                           return {ctor: "_Tuple2"
                                  ...
                                  ,_1: $Effects.none};
                         case "GotRestaurants":
                           var rs = A2($Maybe.withDefault,_U.list([]),_p4._0);
                           return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{restaurants: rs})
                                  ,_1: fetchRatingsFor(rs)};
                         case "SwitchDisplay":
                           return {ctor: "_Tuple2"
                         ...
                         case "ThumbsUp":
                           ...
                           return {ctor: "_Tuple2"
                                  ,_0: _U.update(model
                                                ,{restaurants: A2($List.map,thumbsUp(_p5),model.restaurants)})
                                  ,_1: incStoredRatingFor(_p5)};
                         case "ThumbsDown":
                           var _p6 = _p4._0;
                           return {ctor: "_Tuple2"
                                  ,_0: _U.update(model
                                                ,{restaurants: A2($List.map,thumbsDown(_p6),model.restaurants)})
                                  ,_1: decStoredRatingFor(_p6)};
                         case "RestaurantRatings":
                           return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{restaurants: _p4._0})
                                  ,_1: $Effects.none};
                         default:
                           return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                       }
                    });
       var RestaurantRatings = function (a) {
          return {ctor: "RestaurantRatings",_0: a};
       };
                              ...
                              ,_U.list([viewPageHeader
                                       ...
                                       ,function () {
                                          ...
                                          switch (_p7.ctor)
                                          {
                                            ...
                                            case "Best":
                                              return A2(viewBestDisplay,address,model);
                                            default:
                                              return A2(viewRandomDisplay,address,model);
                                          }
                                       }()]));
                  });
       var GotRestaurants = function (a) {
          return {ctor: "GotRestaurants",_0: a};
       };
       var getRestaurants = $Effects.task(A2($Task.map
                                            ,GotRestaurants
                                            ,$Task.toMaybe(A2($Http.get
                                                             ,decodeRestaurants
                                                             ,restaurantsUrl))));
       var initialModel = {ctor: "_Tuple2"
                          ,_0: {currentPosition: $Maybe.Nothing
                               ,gpsError: $Maybe.Nothing
                               ,restaurants: _U.list([])
                               ,display: Closest}
                          ,_1: getRestaurants};
       var GpsError = function (a) { return {ctor: "GpsError",_0: a};};
       var GpsPosition = function (a) {
          return {ctor: "GpsPosition",_0: a};
       };
...
Elm.Main.make = function (_elm) {
       ...
       var _op = {};
       var storageData =
       Elm.Native.Port.make(_elm).inboundSignal("storageData"
                                               ,"List Restaurant.Restaurant"
                                               ,function (v) {
                                                  return typeof v === "object" && v instanceof Array
                                                      ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
                                                         return typeof v === "object" && "name" in v && "url" in v &&
                                                             "rating" in v && "position" in v ? {_: {}
                                                                                                ,name: typeof v.name === "string" || typeof v.name === "object"
                                                                                                && v.name instanceof String ? v.name : _U.badPort("a string"
                                                                                                                                                 ,v.name)
                                                                                                ,url: typeof v.url === "string" || typeof v.url === "object" &&
                                                                                                v.url instanceof String ? v.url : _U.badPort("a string",v.url)
                                                                                                ,rating: typeof v.rating === "number" && isFinite(v.rating) &&
                                                                                                Math.floor(v.rating) === v.rating ? v.rating
                                                                                                : _U.badPort("an integer",v.rating)
                                                                                                ,position: typeof v.position === "object" && "latitude" in
                                                                                                v.position && "longitude" in v.position ? {_: {}
                                                                                                                                          ,latitude: typeof v.position.latitude
                                                                                                                                          === "number"
                                                                                                                                          ? v.position.latitude
                                                                                                                                          : _U.badPort("a number"
                                                                                                                                                      ,v.position.latitude)
                                                                                                                                          ,longitude: typeof v.position.longitude
                                                                                                                                          === "number"
                                                                                                                                          ? v.position.longitude
                                                                                                                                          : _U.badPort("a number"
                                                                                                                                                      ,v.position.longitude)}
                                                                                                : _U.badPort("an object with fields `latitude`, `longitude`"
                                                                                                            ,v.position)}
                                                             : _U.badPort("an object with fields `name`, `url`, `rating`, `position`"
                                                                         ,v);
       ...
       Elm.Native.Port.make(_elm).outboundSignal("storageCtrl"
                                                ,function (v) {
                                                   return {op: v.op
                                                          ,restaurant: v.restaurant.ctor === "Nothing" ? null
                                                          : v.restaurant._0
                                                          ,restaurants: v.restaurants.ctor === "Nothing" ? null
                                                          : Elm.Native.List.make(_elm).toArray(v.restaurants._0).map(function (v) {
                                                             return {name: v.name
                                                                    ,url: v.url
                                                                    ,rating: v.rating
       ...
       var gpsPosition =
       Elm.Native.Port.make(_elm).inboundSignal("gpsPosition"
                                               ,"Position.Position"
                                               ,function (v) {
                                                  return typeof v === "object" && "latitude" in v && "longitude"
                                                      in v ? {_: {}
                                                             ,latitude: typeof v.latitude === "number" ? v.latitude
                                                             : _U.badPort("a number",v.latitude)
                                                             ,longitude: typeof v.longitude === "number" ? v.longitude
                                                             : _U.badPort("a number",v.longitude)}
                                                      : _U.badPort("an object with fields `latitude`, `longitude`",v);
                                               });
       var app = $StartApp.start({init: $App.initialModel
                                 ,update: $App.update
                                 ,view: $App.view
                                 ,inputs: _U.list([A2($Signal.map,$App.GpsPosition,gpsPosition)
                                                  ,A2($Signal.map,$App.GpsError,gpsError)
                                                  ,A2($Signal.map,$App.RestaurantRatings,storageData)])});
